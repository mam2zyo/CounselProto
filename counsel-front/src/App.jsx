        ...
        <div className="bg-gray-900 min-h-screen flex items-center justify-center">
            <div className="card w-full max-w-sm bg-gray-800 shadow-xl rounded-2xl p-6 md:p-8">
                <div className="card-body items-center text-center">
                    ...
                    {message && (
                        <div className={`alert w-full rounded-lg mb-4 text-sm alert-${messageType} flex items-center justify-between`}>
                            <span>{message}</span>
                        </div>
                    )}
    ...
    const renderChatContent = () => {
        ...
        return messages.map((message) => (
            <div key={message.id} className={`chat ${message.sender === "user" ? "chat-end" : "chat-start"}`}>
                <div className={`chat-bubble ${message.sender === "user" ? "chat-bubble-primary" : ""}`}>
                    {message.text}
                </div>
            </div>
        ));
            ...
            <div className="drawer-content flex flex-col h-screen">
                <div className="navbar bg-base-200">
                    ...
                    <div className="navbar-end gap-2">
                        ...
                        <button className="btn btn-ghost btn-circle" onClick={handleModeChange}>
                ...
                <div className="p-4 bg-base-200">
                    <div className="flex items-center gap-2">
                        ...
                        {(chatMode === "voiceInput" || chatMode === "voiceChat") && (
                            <button className={`btn ${isRecording ? "btn-error" : "btn-primary"} btn-circle`} onClick={handleMicClick}>
                                <MicIcon />
                            </button>
                        )}
                    </div>
